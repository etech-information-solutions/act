...
namespace System
{
    public static class DateTimeExtensions
    {
        ...
        public static DateTime ParseFromEnum( this string input, string format = "" )
        {
            DateTime.TryParseExact( input, format, CultureInfo.InvariantCulture, DateTimeStyles.None, out DateTime d );
