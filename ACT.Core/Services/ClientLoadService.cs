    ...
    public class ClientLoadService : BaseService<ClientLoad>, IDisposable
    {
        ...
        public List<ClientLoadCustomModel> List1( PagingModel pm, CustomSearchModel csm )
        {
            ...
            string query = @"SELECT
                            ...
                            cc.CustomerAccountNo as [CustomerAccountNo],
                            s.Id AS [SiteId],
                            s2.Id AS [ToSiteId],
