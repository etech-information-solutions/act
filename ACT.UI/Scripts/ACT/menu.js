( function ()
{
    ACT.Menu = {
        ...
        {
            if ( $( window ).outerHeight() > ( $( "#welcome-ul" ).outerHeight() + $( "#menu-ul" ).outerHeight() ) )
            {
            ...
            $( "#menu-ul" ).css( { "overflow-y": "auto", "height": ( ( $( window ).outerHeight() - $( "#welcome-ul" ).outerHeight() ) - 20 ) + "px" } );
        }
    }
} )();
...
$( function ()
{
    ACT.Menu.ResizeWidth();
    ACT.Menu.ResizeHeight();
